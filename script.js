...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (sliderContainer) {
    ...
    /*
     * List of image filenames to include in the gallery.  When new images are added
     * to the ``images/`` directory, add their file names to this array to
     * automatically display them in the slider.  We deliberately exclude
     * ``logo.jpg`` and ``portada.jpg`` so the logo and original cover photo
     * aren’t shown in the gallery.  All other JPEG and JPEG‑variant images are
     * included.
     */
    const imageFiles = [
      'frentecabana.jpg',
